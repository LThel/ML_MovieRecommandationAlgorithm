...
critics = pd.read_pickle("critics.pkl")
...
dashboard = st.sidebar.radio(
    ...
    ('A short presentation of the database', 'The evolution of cinema over the years', 'Hate',"Crush"))

if dashboard == 'A short presentation of the database':
    movcrit = st.selectbox("Please choose the dataset you'd like to explore:  ", ("Movies","Critics"))
    if movcrit == "Movies":
        ...
        critic_reviews = critics.groupby('critic_name')['indexcol'].count().reset_index()
    ...
    timeline = st.selectbox("Pick what you'd like to see :  ", ("Charts","Animated Charts"))
    if timeline == "Charts":
